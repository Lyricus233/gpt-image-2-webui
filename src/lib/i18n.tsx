...
const en = {
    ...
    'settings.baseUrlPlaceholder': 'OPENAI_API_BASE_URL',
    'settings.baseUrlHelp': 'The server default is read from OPENAI_API_BASE_URL.',
    ...
    'home.fixedEndpoint': 'API endpoint: {url}',
    'home.apiBaseUrlNotConfigured': 'OPENAI_API_BASE_URL not configured',
    ...
    'form.highResSingleImage': '2K/4K is locked to one image per request to reduce proxy and browser load.',
    ...
    'form.moderationDescription':
        'Controls safety filtering for generated images. Auto uses the default filter; Low relaxes filtering when the API supports it.',
    ...
    'form.sizeEditUnsupported': 'edit unsupported',
    'form.sizeGroup1k': '1K (gpt-image-2 / pro)',
    'form.sizeGroup2k': '2K (pro only)',
    'form.sizeGroup4k': '4K (pro only)',
    'form.sizeProOnly': 'pro only',
    'form.sizeStandardHint': 'Standard size. Multiple images are allowed.',
    ...
    'form.validation.editHighResUnsupported': 'Edit mode only supports 1K sizes. 2K/4K output is blocked.',
    ...
    'page.modelRequired': 'Select or enter a model ID.',
...
const zh: Translations = {
    ...
    'settings.baseUrl': 'Base URL',
    'settings.baseUrlPlaceholder': 'OPENAI_API_BASE_URL',
    'settings.baseUrlHelp': '服务端默认地址从 OPENAI_API_BASE_URL 读取。',
    'settings.apiKey': 'API Key',
    'settings.apiKeyPlaceholder': 'sk-...',
    ...
    'home.fixedEndpoint': '接口地址：{url}',
    'home.apiBaseUrlNotConfigured': '未配置 OPENAI_API_BASE_URL',
    ...
    'form.highResSingleImage': '2K/4K 为降低代理和浏览器负载，单次请求强制只生成 1 张。',
    'form.highFidelityTooltip':
        'gpt-image-2 会始终以高保真方式处理参考图。这样能提升编辑质量，但每次请求会比 gpt-image-1.5 的默认保真度使用更多图片输入 token。',
    'form.moderationDescription': '控制生成图片的安全审核。自动使用默认过滤；低会在 API 支持时放宽过滤。',
    ...
    'form.sizeEditUnsupported': '图生图不支持',
    'form.sizeGroup1k': '1K (gpt-image-2 / pro 均可)',
    'form.sizeGroup2k': '2K (仅 pro)',
    'form.sizeGroup4k': '4K (仅 pro)',
    'form.sizeProOnly': '仅 pro',
    'form.sizeStandardHint': '标准尺寸，允许多张生成。',
    ...
    'form.validation.editHighResUnsupported': '图生图仅支持 1K 尺寸，已禁止 2K/4K 输出。',
    ...
    'valueComparison.fixedDeal': '本站额度很简单：1 元始终可以生成 10 张图。',
    ...
    'page.modelRequired': '请选择或输入模型 ID。',
